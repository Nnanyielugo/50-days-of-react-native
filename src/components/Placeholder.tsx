/**
 * copied from https://github.com/chramos/react-native-skeleton-placeholder
 * copied because I didn't want to innstall another masked view Library
 * since I was already using @react-native-community/masked-view for navigation
 */
...
export default function SkeletonPlaceholder({
  ...
  const translateX = React.useMemo(
    ...
    [animatedValue], // eslint-disable-line react-hooks/exhaustive-deps
  );
